...
return [
    ...
    */
    ...
    "after_or_equal" => "The  :thuộc tính phải là ngày sau hoặc bằng :date.",
    ...
    "exists" => ":attribute phải là một ngày sau :date",
    ...
    "invalid_date" => ":attribute không hợp lệ. Vui lòng đặt thời gian cách hiện tại 24h",
    "date_required" => "Vui lòng chọn :attribute",
    "list" => "Danh sách :attribute",
